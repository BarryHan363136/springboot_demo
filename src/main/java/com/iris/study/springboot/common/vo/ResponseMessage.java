package com.iris.study.springboot.common.vo;
...
public class ResponseMessage {
    ...
    public ResponseMessage withConditions(String conditions){
    ...
    public static void main(String[] args) {
        ...
        // packageData("data", list).
        // withConditions(articleQueryForm.toString());;
    }
